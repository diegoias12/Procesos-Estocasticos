...
function MetodoExhaustivo(n, m, elemTr){
  ...
  $('div[name="procedimiento"]').append('<img id="formula" src="img/estadoEstable.PNG">');
  $('div[name="procedimiento"]').append('<img id="formula" src="img/estadoEstableUnidad.PNG">');
  ...
  $('div[name="procedimiento"]').append('<img id="formula" src="img/valor.PNG">');
  // Obtener valor de la politica
  $('div[name="procedimiento"]').append('<p id="resultado"> Resultado=' + ValorPolitica(poli, prob, cost) + '</p>');
}
